...
do
 ...
 echo "df_merged.to_csv('medicinals_county_$f.csv')" >> merge_county_medicinal.py
...
#
## remove pandas autogenerated serial ids column
## awk -F, '{ OFS=", "; print $3, $4 }' medicinals_county_$f.csv > medicinals_county_reduced_rows_$f.csv
